...
def Mental_Agent(user_id: Optional[str] = typer.Argument(None, help="User ID for the Mental session")):
    ...
    agent = Agent(
        ...
        description="you are a psychiatrists for students who are studying engineering.",
        instructions=[
            "Search your knowledge base for having an idea of how to have an conversation with the students according to their mental health.",
