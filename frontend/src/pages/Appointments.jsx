                  ...
                  <div className="flex items-center space-x-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[var(--custom-orange-600)] mt-2 flex items-center gap-2">
                        ...
                        {format(appointment.dateTime, "dd-MMM-yyyy hh:mm a")}
                      </p>
                    </div>
                  </div>
                    ...
                    {!appointment.stars ? (
                      ...
                      >
                        <Rating
                          ...
                          sx={{
                            "& .MuiRating-iconFilled": { color: "var(--custom-orange-600)" },
                            "& .MuiRating-iconHover": { color: "var(--custom-orange-700)" },
                          }}
                        />
                        <button
                          type="submit"
                      ...
                      <span className="text-[var(--custom-orange-600)] font-semibold text-sm flex items-center gap-2">
                        <CheckCircle className="w-5 h-5" /> Rating Submitted!
                      </span>
                    )}
                  </div>
                </div>
