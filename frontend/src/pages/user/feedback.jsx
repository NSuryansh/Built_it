...
const StarRating = ({ value, onChange, label }) => {
  return (
    <div className="flex flex-col items-center">
      {label && (
        <p className="mb-2 text-sm text-[var(--custom-gray-600)]">{label}</p>
      )}
...
const FeedbackPage = () => {
  ...
  const submitFeedback = async () => {
    ...
    try {
      const res = await fetch(
        "http://localhost:3000/api/user/setFeedback",
        {
          method: "POST",
          headers: {
          ...
          <div className="space-y-3">
            {question.options?.map((option) => (
              ...
              >
                ...
                />
                <span className="text-[var(--custom-gray-700)]">{option}</span>
              </label>
            ))}
          </div>
        );
      case "text":
        return (
          <textarea
            ...
            rows={4}
            className="w-full p-3 border border-[var(--custom-gray-300)] rounded-lg focus:ring-2 focus:ring-[var(--custom-orange-300)] focus:border-transparent transition duration-200"
  ...
  return (
    <div className="page-transition py-6 max-w-3xl mx-auto">
      {submitted ? (
        <div className="bg-[var(--custom-white)] rounded-2xl shadow-xl p-10 text-center">
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 bg-[var(--custom-green-100)] rounded-full flex items-center justify-center">
              <CheckCircle className="w-10 h-10 text-[var(--custom-green-600)]" />
            </div>
          </div>
          <h2 className="text-2xl font-bold text-[var(--custom-gray-800)] mb-4">
            Thank You for Your Feedback!
          </h2>
          <p className="text-[var(--custom-gray-600)] mb-8">
        ...
        <>
          ...
          <div className="bg-[var(--custom-white)] rounded-2xl shadow-lg p-6 mb-8 border border-[var(--custom-orange-100)]">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[var(--custom-gray-600)]">{doc.desc}</p>
                <div className="flex items-center gap-6 mt-3">
                  <p className="text-sm flex items-center gap-2">
                    <Calendar className="w-4 h-4 text-[var(--custom-gray-500)]" />
                    {format(appointment.createdAt, "dd MMM yyyy")}
                  </p>
                  <p className="text-sm flex items-center gap-2">
                    <Clock className="w-4 h-4 text-[var(--custom-gray-500)]" />
          ...
          {currentStep === 0 && (
            <div className="bg-[var(--custom-white)] rounded-2xl shadow-md p-8 mb-8 feedback-question">
              ...
              <div className="flex justify-center mt-6">
                <button
                  onClick={handleNext}
                  className="bg-[var(--custom-orange-500)] text-[var(--custom-white)] px-6 py-2 rounded-md font-semibold shadow-sm hover:bg-[var(--custom-orange-600)] transition-all duration-200 hover:-translate-y-[1.5px] focus:outline-none focus:ring-2 focus:ring-[var(--custom-orange-300)] focus:ring-opacity-50"
                >
                  Next
                </button>
              </div>
          ...
          {currentStep > 0 && currentStep <= questions.length && (
            <div className="bg-[var(--custom-white)] rounded-2xl shadow-md p-8 mb-8 feedback-question">
              ...
              <div className="h-2 w-full bg-[var(--custom-gray-200)] rounded-full mb-8">
                <div
              ...
              <div className="flex justify-between mt-8">
                <button
                  ...
                  className="bg-[var(--custom-gray-100)] text-[var(--custom-gray-700)] px-6 py-2 rounded-md font-semibold shadow-sm hover:bg-[var(--custom-gray-200)] transition-all duration-200 hover:-translate-y-[1.5px] focus:outline-none focus:ring-2 focus:ring-[var(--custom-gray-300)] focus:ring-opacity-50"
                >
                  Previous
                </button>
