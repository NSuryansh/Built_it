    ...
    <div className="space-y-6 py-10 w-full bg-[var(--custom-primary-green-50)] mx-auto flex flex-col justify-center items-center">
      ...
      <div className="bg-white p-6 min-w-2xl rounded-xl shadow-lg max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="date" className="block text-sm font-medium text-[var(--custom-primary-green-900)]">
              Date
            </label>
            <input
              type="date"
          ...
          <div className="space-y-2">
            <label htmlFor="location" className="block text-sm font-medium text-[var(--custom-primary-green-900)]">
              Location
            </label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            <label htmlFor="description" className="block text-sm font-medium text-[var(--custom-primary-green-900)]">
              Description
            </label>
            <textarea
              id="description"
