...
const AddDoctor = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-orange-900">Add New Doctor</h1>
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="specialty" className="block text-sm font-medium text-orange-900">
              Specialty
            </label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            <label htmlFor="phone" className="block text-sm font-medium text-orange-900">
              Phone Number
            </label>
            <input
              type="tel"
