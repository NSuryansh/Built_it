...
const DoctorsList = () => {
  ...
  const handleToggleDoc = async (doctor) => {
    ...
    console.log(doctor);
    try {
      const res = await fetch(" /api/admin/toggleDoc", {
        method: "POST",
        headers: {
  ...
  return (
    <div
      className={`flex flex-col min-h-screen bg-gradient-to-br from-[var(--custom-green-50)] via-[var(--custom-white)] to-[var(--custom-green-100)]`}
    >
      <AdminNavbar />
      <ToastContainer />
      ...
      <div className="w-full max-w-7xl mx-auto p-6 space-y-10">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-[var(--custom-white)] to-[var(--custom-teal-100)] rounded-3xl shadow-2xl p-8 mb-12">
          <div className="absolute inset-0 bg-grid-[var(--custom-white)]/10 [mask-image:linear-gradient(0deg,transparent,black)]"></div>
        ...
        <div className="bg-[var(--custom-white)] rounded-2xl shadow-lg p-4 mb-8">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-1">
              <Search
                className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[var(--custom-gray-400)]"
                size={20}
              />
              <input
                type="text"
        ...
        <div className="hidden md:block overflow-hidden bg-[var(--custom-white)] rounded-3xl shadow-xl border border-[var(--custom-green-100)] animate-fade-in-up">
          <table className="w-full text-sm text-left">
            <thead className="bg-gradient-to-r from-[var(--custom-green-100)] to-[var(--custom-teal-100)] text-[var(--custom-green-900)] font-semibold">
              <tr>
            ...
            <tbody className="divide-y divide-[var(--custom-green-50)]">
              {filteredDoctors.map((doctor) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-[var(--custom-gray-600)]">
                    {doctor.email}
                  </td>
                  <td className="px-6 py-4">
        ...
        <div className="md:hidden space-y-6">
          {filteredDoctors.map((doctor) => (
            <div
              key={doctor.id}
              className="backdrop-blur-sm bg-[var(--custom-white)]/90 border border-[var(--custom-green-100)] rounded-2xl shadow-lg p-6 space-y-4 animate-fade-in-up hover:shadow-xl transition-all duration-300"
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[var(--custom-gray-900)]">
                      {doctor.name}
                    </h3>
                    <div className="flex">
