...
const UserDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[var(--custom-blue-50)] to-[var(--custom-purple-50)]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <div className="space-y-6">
          <div className="bg-[var(--custom-white)]/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl border border-[var(--custom-blue-100)]/50 p-4 sm:p-6 lg:p-8">
