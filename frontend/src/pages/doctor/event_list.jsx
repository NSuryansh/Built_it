...
const DoctorEventsList = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        CustomToast("Failed to delete the event", "blue");
      }
    } catch (error) {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        CustomToast("Error while fetching events", "blue");
        setfetched(false);
      }
    };
  ...
  return (
    <div className="flex bg-gradient-to-br from-[var(--custom-blue-50)] to-[var(--custom-teal-50)] flex-col min-h-screen">
      <DoctorNavbar />
      <ToastContainer />
      ...
      <div className="max-w-7xl w-full p-4 md:p-8 mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl text-center md:text-start md:text-3xl lg:text-4xl font-bold text-[var(--custom-blue-900)] mb-2">
              Events Dashboard
            </h1>
            <p className="text-[var(--custom-blue-600)]">
          ...
          <Link
            to="/doctor/add_event"
            className="group flex items-center gap-2 bg-[var(--custom-blue-600)] text-[var(--custom-white)] px-3 py-1.5 md:px-6 md:py-3 rounded-full hover:bg-[var(--custom-blue-700)] transition-all duration-300 shadow-lg hover:shadow-[var(--custom-blue-200)] mt-4 md:mt-0"
          >
          ...
          <div className="p-6 border-b border-[var(--custom-gray-100)]">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-[var(--custom-gray-900)] flex items-center gap-2">
                <Filter className="w-5 h-5 text-[var(--custom-blue-600)]" />
                Filters
              </h2>
              <button
                onClick={() => {
                ...
                className="text-[var(--custom-blue-600)] hover:text-[var(--custom-blue-700)] font-medium text-sm"
              >
            ...
            <div className="flex flex-col gap-6 justify-between items-center sm:flex-row">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-lg border border-[var(--custom-gray-200)] focus:border-[var(--custom-blue-500)] focus:ring-2 focus:ring-[var(--custom-blue-200)] outline-none transition-all"
                />
              </div>
              <div className="bg-[var(--custom-white)] p-2 md:p-4 flex justify-center gap-4 items-center rounded-2xl border-2 border-[var(--custom-blue-500)]">
                <h3 className="text-[var(--custom-blue-600)] font-semibold text-nowrap text-lg">
                  Total Events
                </h3>
                <p className="text-3xl font-bold text-[var(--custom-blue-600)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium text-[var(--custom-gray-700)] mb-2 flex items-center gap-2">
                    <CalendarDays className="w-4 h-4 text-[var(--custom-blue-600)]" />
                    Time Period
                  </label>
                  <select
                    value={dateFilter}
                    onChange={(e) => setDateFilter(e.target.value)}
                    className="w-full px-4 py-2 rounded-lg border border-[var(--custom-gray-200)] focus:border-[var(--custom-blue-500)] focus:ring-2 focus:ring-[var(--custom-blue-200)] outline-none"
                  >
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <h2 className="text-xl font-semibold text-[var(--custom-gray-900)] group-hover:text-[var(--custom-blue-700)] transition-colors">
                    {event.title}
                  </h2>
                </div>
              ...
              <div className="mt-6 grid sm:grid-cols-2 gap-6">
                <div className="flex items-center gap-2">
                  <Clock className="w-5 h-5 text-[var(--custom-blue-500)]" />
                  <div>
                ...
                <div className="flex items-center gap-2">
                  <MapPin className="w-5 h-5 text-[var(--custom-blue-500)]" />
                  <div>
                    <p className="text-sm text-[var(--custom-gray-500)]">
                      Location
                    </p>
              ...
              <div className="mt-4 pt-4 border-t border-[var(--custom-gray-100)]">
                <div className="flex items-center gap-2 mb-2">
                  <LinkIcon className="w-4 h-4 text-[var(--custom-blue-500)]" />
                ...
                {editingLinkId === event.id ? (
                  <div className="flex flex-col sm:flex-row gap-2 mt-2">
                    <input
                      ...
                      className="flex-1 text-sm border rounded-lg px-3 py-2 focus:ring-2 focus:ring-[var(--custom-blue-200)] focus:border-[var(--custom-blue-500)] outline-none"
                    />
                    <div className="flex gap-2">
                      <button
                        onClick={() => handleLinkSubmit(event.id)}
                        className="bg-[var(--custom-blue-500)] text-[var(--custom-white)] px-4 py-2 rounded-lg hover:bg-[var(--custom-blue-600)] transition-colors text-sm"
                      >
                        Save
                      </button>
                      <button
                    ...
                    {event.link ? (
                      <>
                        <a
                          ...
                          className="text-[var(--custom-blue-600)] hover:text-[var(--custom-blue-700)] text-sm font-medium"
                        >
                          View Document
                        </a>
                        <button
...
export default DoctorEventsList;
