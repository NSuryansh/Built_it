...
const DoctorAppointment = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const docId = localStorage.getItem("userid");
      const res = await fetch(`https://built-it-backend.onrender.com/reqApp?docId=${docId}`);
  ...
  const acceptApp = async (appointment) => {
    ...
    const res = await fetch("https://built-it-backend.onrender.com/book", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        userId: appointment["user_id"],
  ...
  const deleteApp = async (appointment) => {
    const res = await fetch("https://built-it-backend.onrender.com/deleteApp", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
  ...
  const emailParams = async (appointment, time) => {
    ...
    const res = await fetch("https://built-it-backend.onrender.com/reschedule", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        appId: appointment["id"],
