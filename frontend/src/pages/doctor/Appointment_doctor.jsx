                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-center sm:items-start space-x-7">
                      ...
                      <div className="flex-1 mt-4 sm:mt-0 scale-90 sm:scale-100 space-y-6">
                        ...
                        <div className="flex justify-center items-center flex-col xl:flex-row xl:space-x-5 space-y-3 xl:space-y-0">
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-center sm:items-start space-x-7">
                      ...
                      <div className="flex-1 mt-4 sm:mt-0 scale-90 sm:scale-100 space-y-6">
                        ...
                        <div className="flex flex-col justify-center items-center xl:flex-row xl:space-x-5 space-y-3 xl:space-y-0">
                          <button
