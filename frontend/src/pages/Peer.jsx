...
//   const navigate = useNavigate();
//   const socketRef = useRef(null);
//   // Remove the string ref used for duplicate checking if not needed
//   // const lastMessageRef = useRef("");

//   // New ref for scrolling to bottom
...
//   // Handle receiving messages and update showMessages
//   useEffect(() => {
//     if (!aesKey || !isAuthenticated) return;
...
//   // Effect to scroll to the bottom whenever showMessages changes
//   useEffect(() => {
