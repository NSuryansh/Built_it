...
const SignUp = () => {
  ...
  async function sendOTP() {
    try {
      const response = await fetch("http://built-it-xjiq.onrender.com/otpGenerate", {
        method: "POST",
  ...
  async function verifyOTP() {
    try {
      const response = await fetch("http://built-it-xjiq.onrender.com/otpcheck", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          otp: otp,
  ...
  async function handleInitialSignup() {
    ...
    try {
      const response = await fetch(
        `http://built-it-xjiq.onrender.com/check-user?username=${formData.username}`
      );
      const data = await response.json();
  ...
  async function handleOTPVerification() {
    ...
    try {
      ...
      const { username, email, mobile, password, altNo, department, rollNo } =
        formData;
      const response = await fetch("http://built-it-xjiq.onrender.com/signup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          username: username,
