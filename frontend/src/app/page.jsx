...
const App = () => {
  ...
  return (
    <div className="min-h-screen">
      <Navbar />
      <div className="bg-custom-orange-100">
        <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center flex flex-col items-center">
              ...
              <Link
                href="/user/signup"
                className="bg-custom-orange-500 text-custom-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-custom-orange-600 w-fit transition-colors duration-300 flex items-center"
              >
                Get Started
        ...
        {/* Features Section */}
        <div className="py-16 bg-custom-white backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-custom-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                <div className="h-12 w-12 bg-custom-orange-100 rounded-lg flex items-center justify-center mb-6">
                  <Brain className="h-6 w-6 text-custom-orange-500" />
                </div>
              ...
              <div className="bg-custom-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                <div className="h-12 w-12 bg-custom-orange-100 rounded-lg flex items-center justify-center mb-6">
                  <Users className="h-6 w-6 text-custom-orange-500" />
                </div>
                <h3 className="text-xl font-semibold mb-4">
              ...
              <div className="bg-custom-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                <div className="h-12 w-12 bg-custom-orange-100 rounded-lg flex items-center justify-center mb-6">
                  <Sparkles className="h-6 w-6 text-custom-orange-500" />
                </div>
                <h3 className="text-xl font-semibold mb-4">
                  Wellness Resources
                </h3>
        ...
        <div className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto bg-custom-orange-500 rounded-2xl overflow-hidden shadow-xl">
            <div className="flex flex-col md:flex-row items-center px-8 py-16 justify-evenly text-center">
              <div className="">
                <h2 className="text-3xl font-bold text-custom-white mb-4">
                  Start Your Journey Today
                </h2>
                <p className="text-custom-orange-50 mb-8 max-w-2xl mx-auto">
                  Take the first step towards better mental health. Our team of
                  professionals is here to support you every step of the way.
                </p>
                <Link href="/user/book">
                  <button className="bg-custom-white text-custom-orange-500 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-custom-orange-50 transition-colors duration-300">
