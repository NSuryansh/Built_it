              ...
              <div className="relative group">
                {profileImage ? (
                  <img
                    src={profileImage}
                    alt="Profile"
                    className="w-24 h-24 lg:w-32 lg:h-32 border-4 border-[var(--custom-yellow-300)] rounded-full object-cover shadow-xl group-hover:scale-[1.15] transition-transform duration-500 ease-out"
                  />
                ) : (
