...
const Book = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-custom-orange-50 via-custom-orange-100 to-custom-orange-200 flex flex-col overflow-hidden">
      <Navbar />
      <ToastContainer />

      <div className="flex-1 flex justify-center items-center px-2 sm:px-6 md:px-10 py-12">
        <div className="w-full max-w-full bg-custom-white/70 backdrop-blur-lg rounded-xl md:rounded-3xl shadow-lg px-2 py-6 md:p-10 border border-custom-orange-200/50 transition-all duration-500 hover:shadow-3xl">
          <div className="flex justify-center mb-8">
            <div className="flex items-center gap-4">
              <div
                className={`w-10 h-10 flex items-center justify-center rounded-full font-semibold text-custom-white transition-all duration-300 ${
                  step === 1
                    ? "bg-custom-orange-500 scale-110"
                    : "bg-custom-gray-300"
                }`}
              >
                1
              </div>
              <div className="w-16 h-1 bg-custom-gray-300 rounded-full" />
              <div
                className={`w-10 h-10 flex items-center justify-center rounded-full font-semibold text-custom-white transition-all duration-300 ${
                  step === 2
                    ? "bg-custom-orange-500 scale-110"
          ...
          {step === 1 && (
            <div className="min-h-[40.5rem] flex items-center justify-center animate-fade-in">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-custom-gray-900 mb-6">
                  Select Your Buddy
                </h2>
                <DoctorSelectionStep
                  doctors={doctors}
