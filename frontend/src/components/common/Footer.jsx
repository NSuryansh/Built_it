...
const Footer = ({ color }) => {
  return (
    <footer className="bg-custom-white border-t border-custom-gray-200">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col py-4 md:py-0 md:flex-row justify-between">
          <div className="w-full md:w-1/3">
            ...
            <p className="mt-2 text-sm text-custom-gray-500">
          ...
          <div className="space-y-4 w-full md:w-1/3 py-4 md:py-0">
            ...
            <div className="space-y-2">
              <a
                ...
                className={`flex items-center space-x-2 text-sm text-custom-gray-500 hover:${
                  color === "orange"
                    ? "text-custom-orange-500"
                    : color === "green"
                    ? "text-custom-green-500"
          ...
          <div className="space-y-4 py-4 md:py-0">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-sm text-custom-gray-500">
                <Phone size={18} />
        ...
        <div className="md:mt-4 pt-2 border-t border-custom-gray-200">
          <p className="text-sm text-custom-gray-500 text-center">
