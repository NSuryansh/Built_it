...
const ErrorBoundaryFallback = ({ userType }) => {
  ...
  const bgClass = `bg-[var(--custom-${color}-100)]`;
  const iconColorClass = `text-[var(--custom-${color}-500)]`;
  const buttonBgClass = `bg-[var(--custom-${color}-500)] hover:bg-[var(--custom-${color}-600)]`;
