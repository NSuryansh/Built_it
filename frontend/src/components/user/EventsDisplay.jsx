            ...
            <div className="p-6">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <h3 className="mt-3 text-xl font-bold text-[var(--custom-gray-900)] group-hover:text-[var(--custom-gray-800)]">
                    {event.title}
                  </h3>
                  <p className="mt-2 text-[var(--custom-gray-600)] line-clamp-2">
                    {event.description}
                  </p>
                </div>
              </div>

              <div className="mt-4 flex flex-wrap items-center gap-1 sm:gap-4 text-[var(--custom-gray-600)]">
                <div className="flex items-center gap-2">
                  <div className="p-1 rounded-full bg-[var(--custom-peach)]">
