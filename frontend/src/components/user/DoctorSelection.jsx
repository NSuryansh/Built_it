      ...
      {doctors.length > 0 ? (
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-6">
          {doctors.map((doctor) => (
            <div
              key={doctor.id}
              className="group w-full bg-[var(--custom-white)] hover:bg-[var(--custom-orange-50)] p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border border-[var(--custom-orange-100)] hover:border-[var(--custom-orange-200)]"
